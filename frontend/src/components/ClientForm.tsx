...
interface ClienteFormProps {
    register: UseFormRegister<ClienteCreate>;
    errors: FieldErrors<ClienteCreate>;
    watch: UseFormWatch<ClienteCreate>;
    isPending: boolean;
...
export default function ClientForm({ register, errors, watch, isPending }: ClienteFormProps) {
